...
the_numbers = {
    ...
    'text_play_color': {'normal': (0, 255, 0), 'night': (0, 0, 0)},
    'text_play_color_motion': {'normal': (255, 255, 255), 'night': (0, 255, 0)},
    'text_play_x': int(441/d),
    'text_play_y': 0,
    'text_help_color': {'normal': (255, 165, 0), 'night': (0, 0, 0)},
    'text_help_color_motion': {'normal': (255, 255, 255), 'night': (255, 165, 0)},
